(* generated by Ott 0.25, locally-nameless from: Recur.ott *)
...
Fixpoint open_trm_wrt_trm_rec (k:nat) (e_5:trm) (e__6:trm) {struct e__6}: trm :=
  ...
  | (trm_mu A e) => trm_mu (open_trm_wrt_trm_rec k e_5 A) (open_trm_wrt_trm_rec (S k) e_5 e)
...
Inductive lc_trm : trm -> Prop :=    (* defn lc_trm *)
 ...
 | lc_trm_mu : forall (L:vars) (A e:trm),
     (lc_trm A) ->
      ( forall x5 , x5 \notin  L  -> lc_trm  ( open_trm_wrt_trm e (trm_var_f x5) )  )  ->
     (lc_trm (trm_mu A e))
...
Fixpoint fv_trm (e_5:trm) : vars :=
  ...
  | (trm_mu A e) => (fv_trm A) \u (fv_trm e)
...
Fixpoint subst_trm (e_5:trm) (y5:var) (e__6:trm) {struct e__6} : trm :=
  ...
  | (trm_mu A e) => trm_mu (subst_trm e_5 y5 A) (subst_trm e_5 y5 e)
...
Inductive reduct : trm -> trm -> Prop :=    (* defn reduct *)
 ...
 | reduct_mu : forall (A e:trm),
     lc_trm A ->
     lc_trm (trm_mu A e) ->
     reduct (trm_mu A e)  (open_trm_wrt_trm  e   (trm_mu A e) ) 
...
Inductive sub : env -> trm -> trm -> trm -> Prop :=    (* defn sub *)
 ...
 | sub_prod : forall (L:vars) (G:env) (e A B A' B':trm),
     sub G A' A trm_star ->
      sub ( G ) ( e ) ( e ) ( A' )  ->
      sub ( G ) ( A ) ( A ) ( trm_star )  ->
 ...
 | sub_mu : forall (L:vars) (G:env) (A e:trm),
      sub ( G ) ( A ) ( A ) ( trm_star )  ->
      ( forall x5 , x5 \notin  L  ->  sub (  ( G  &  x5 ~ (bind_sub trm_top A) )  ) (  ( open_trm_wrt_trm e (trm_var_f x5) )  ) (  ( open_trm_wrt_trm e (trm_var_f x5) )  ) ( A )  )  ->
     sub G  ( (trm_mu A e) )   ( (trm_mu A e) )  A

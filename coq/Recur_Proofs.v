...
Require Import Recur_ott Recur_Infra.
...
Proof.
  ...
  apply* subst_fresh.
  rewrite <- W at 3.
  apply_empty* (@sub_substitution A trm_top).  
  (* case castup *)  
  unfold SubLemma; introv Red1 Red2.
...
Proof.
  ...
  (* case: mu *)
  right. asserts W: (lc_trm (trm_mu A e)).
  apply_fresh* lc_trm_mu as y. lets: H0 y __. auto. auto.
  exists* (e ^^ (trm_mu A e)).
  (* case: castdn *)
